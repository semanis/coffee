...
public class CoffeeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTotalRoasts = new javax.swing.JLabel();
        textRoastCount = new javax.swing.JTextField();
        ...
        btnAddRoastLog.setMaximumSize(new java.awt.Dimension(238, 44));
        btnAddRoastLog.setMinimumSize(new java.awt.Dimension(238, 44));
        btnAddRoastLog.setPreferredSize(new java.awt.Dimension(238, 44));
        ...
        btnAddCompare.setFont(new java.awt.Font("SansSerif.plain", 0, 20)); // NOI18N
        btnAddCompare.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/smanis/coffee/assets/scales.png"))); // NOI18N
        btnAddCompare.setMnemonic('C');
        btnAddCompare.setText("Add/Compare");
        btnAddCompare.setMaximumSize(new java.awt.Dimension(238, 44));
        btnAddCompare.setMinimumSize(new java.awt.Dimension(238, 44));
        btnAddCompare.setPreferredSize(new java.awt.Dimension(238, 44));
        btnAddCompare.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddCompareActionPerformed(evt);
            }
        });
        panelButtonsRoastLog.add(btnAddCompare);
        ...
        btnEditRoastLog.setMaximumSize(new java.awt.Dimension(238, 44));
        btnEditRoastLog.setMinimumSize(new java.awt.Dimension(238, 44));
        btnEditRoastLog.setPreferredSize(new java.awt.Dimension(238, 44));
        ...
        btnDeleteRoastLog.setMaximumSize(new java.awt.Dimension(238, 44));
        btnDeleteRoastLog.setMinimumSize(new java.awt.Dimension(238, 44));
        btnDeleteRoastLog.setPreferredSize(new java.awt.Dimension(238, 44));
        ...
        textRoastCount.setMinimumSize(new java.awt.Dimension(80, 47));
        textRoastCount.setPreferredSize(new java.awt.Dimension(80, 47));
        jPanel1.add(textRoastCount);
        ...
        menuUtility.setMnemonic('U');
        menuUtility.setText("Utility");
        menuUtility.setFont(new java.awt.Font("Dialog", 0, 20)); // NOI18N

        menuItemCalculate.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F5, 0));
        menuItemCalculate.setFont(new java.awt.Font("Dialog", 0, 20)); // NOI18N
        menuItemCalculate.setText("Calculate Bean Utililization");
        menuItemCalculate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        setSize(new java.awt.Dimension(1667, 1049));
    ...
    private void addRoast(NonEditableTableModel roastModel, int roastRow) {
        ...
        // Instantiate a new RoastLogEdit JDialog in modal mode (hold execution until the dialog is closed).
        RoastLogEdit rle = new com.smanis.coffee.forms.RoastLogEdit(this, true);
        rle.setBeanModel(beanModel);
        // When adding a new roast log,  default to today's date.
        rle.setRoastStartDate(new Date());

        if (roastModel != null) {
            rle.setComparisonRoast(roastModel, roastRow);
        }
    ...
    private void btnAddCompareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCompareActionPerformed
        NonEditableTableModel roastTableModel = (NonEditableTableModel) this.tableRoasts.getModel();
        int selectedRoastRow = this.tableRoasts.getSelectedRow();
        this.addRoast(roastTableModel, selectedRoastRow);
    ...
    private void menuItemCalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemCalculateActionPerformed
        ...
        float totalGreenWeight = 0.0f;
        //453.592
        
        for (int i = 0; i < roastCount; i++) {
            totalGreenWeight += Float.valueOf((String)roastLogModel.getValueAt(i, columnIndex));
        }
        
        String message = String.format("Total utilization for bean '%s':\n\n%.2f g\n\n%.2f lbs", beanModel.getBeanName(), totalGreenWeight, totalGreenWeight / 453.592);
    ...
    /**
     * Gets the count of all roast logs.s
     */
    private void getRoastCount() {
    try {
        ResultSet rs = DataService.getInstance().getRoastCount();
        if (rs.next()) {
            this.textRoastCount.setText(String.valueOf(rs.getInt("RoastCount")));
        }

    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "CoffeeFrame.getRoastCount() " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        e.printStackTrace();
    }
}
    ...
    try {
        ...
        // Action listener to move left a tab in the tabbed pane.
        ...
        // Action listener to move right a tab in the tabbed pane.
        ...
        // Set keystroke handler for ESCAPE, which confirms exiting the program.
        KeyStroke strokeEscape = KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0);

        // Set keystroke handlers for ALT+left arrow and ALT+right arrow, to move between tabs.
        ...
        // Register all the action listeners with their assigned keystrokes.
        ...
        // Prevents the default "navigate down" on ENTER for the Beans table.
        ...
        // Prevent default "navigate down" on ENTER for the Roasts table.    
        ...
        // Use a runner to focus the bean list on init.
        Runnable runner = () -> {
    ...
    private javax.swing.JLabel labelTotalRoasts;
    ...
    private javax.swing.JTextField textRoastCount;
