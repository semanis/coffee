...
public class Utility {
   ...
   /**
    * Convenience method to calculate the minutes/seconds between two time-based fields.
    *
   ...
   /**
    * JFormattedTextFields won't highlight their contents on focus via a call to its own selectAll() method. This generic method cures that issues by way of a runnable,
    * which gets the process off the main Swing GUI thread, so that the GUI thread can finish it's work first.
    *
   ...
   /**
    * Sets the value of a specified JFormattedTextField to a formatted String representation of the specified date.
    *
   ...
   /**
    * Validates that a field is not empty and that the value specified is valid, based on the type of field.
    *
    * @param textField Any field derived from JTextField (which includes JFormattedTextFields).
    *
